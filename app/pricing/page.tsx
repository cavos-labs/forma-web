    ...
    <main className="px-4 py-16 md:px-8 md:py-24">
      <div className="mx-auto grid max-w-[1400px] gap-16 lg:grid-cols-2 lg:items-start">
        <Reveal>
          ...
          <p className="mt-6 text-base text-[color:color-mix(in_srgb,var(--fg)_65%,transparent)]">
        ...
        <Reveal className="border-t border-[color:color-mix(in_srgb,var(--fg)_16%,transparent)] pt-10 lg:border-l lg:border-t-0 lg:pl-16 lg:pt-0">
          ...
          <ul className="mt-10">
            {copy.pricing.features.map((feature) => (
              <li
                key={feature}
                className="border-b border-[color:color-mix(in_srgb,var(--fg)_12%,transparent)] py-4 text-base text-[var(--fg)] first:border-t"
              >
                {feature}
              </li>
            ))}
          ...
          {currency === "CRC" && pricing.exchangeRate && (
            <p className="mt-8 text-xs text-[color:color-mix(in_srgb,var(--fg)_50%,transparent)]">
              {language === "ES"
