  ...
  const handleFileChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (selectedFile) {
      ...
      if (!allowedTypes.includes(selectedFile.type)) {
        setErrorMessage('Por favor selecciona una imagen válida (JPEG, PNG, WebP)');
        return;
      }
        ...
        <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              Tu comprobante de pago ha sido enviado exitosamente. El gimnasio lo revisará y aprobará tu membresía pronto.
            </p>
          </div>
          <div className="bg-blue-50 rounded-lg p-4">
            <p className="text-sm text-blue-800">
              Recibirás una notificación una vez que tu pago sea aprobado y tu membresía esté activa.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-md mx-auto">
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-gray-800 to-gray-700 px-6 py-8 text-center">
            ...
            />
            <h1 className="text-2xl font-bold text-white">Subir Comprobante de Pago</h1>
            <p className="text-gray-200 mt-2">Sube tu comprobante SINPE para activar tu membresía</p>
          </div>
          ...
          <div className="px-6 py-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {/* SINPE Reference */}
              <div>
                <label htmlFor="sinpeReference" className="block text-sm font-medium text-gray-700 mb-2">
              ...
              {/* SINPE Phone */}
              <div>
                <label htmlFor="sinpePhone" className="block text-sm font-medium text-gray-700 mb-2">
            ...
            <div className="mt-8 bg-gray-50 rounded-lg p-4">
              ...
              <ol className="text-sm text-gray-600 space-y-1">
                <li>1. Toma una captura de pantalla clara del comprobante SINPE</li>
